    ...
    >
      ...
      <div className="w-full max-w-[430px] mx-auto px-1 flex flex-col items-center" style={{ gap: '5px' }}>
        ...
        >
          ...
          {/* Main video container - side by side videos */}
          <div className="flex flex-row w-full h-full gap-0">
            ...
            <div className="flex-1 flex items-center justify-center bg-black relative">
              ...
              />
              {/* Show loading line when skeleton is loading (user video only) */}
              {loadingSkeleton && (
            ...
            <div className="flex-1 flex items-center justify-center bg-black relative">
              <SwingPlayer
                ...
                isReplaying={isReplaying}
              />
              {/* Hogan skeleton overlay (now over the reference video) */}
